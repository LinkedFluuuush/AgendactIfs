...
$req = "SELECT idutilisateur, nom, prenom, adresse_mail FROM aci_utilisateur WHERE aci_utilisateur.identifiant_de_connexion='".$login."' AND aci_utilisateur.pass='".$mdp."'";
