<?php
	...
	$auteur = utf8_decode(decodeURI($_POST['auteur']));
	...
	if($auteur != null)
	{
		$sql = $sql . $prefixe . "eve_utilisateur.nomCompletUtilisateur like '%$auteur%' ";
		$prefixe = "AND ";
	}
	...
	if(!$resultat)
		echo '<option label="" disabled="disabled"> Aucun &eacute;v&eacute;nement trouv&eacute;. </option>';
?>
